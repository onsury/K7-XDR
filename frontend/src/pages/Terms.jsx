...
export default function Terms() {
  ...
  const sections = [
    { title: "1. Acceptance of Terms", content: "By accessing or using the K7 XDR Platform, you agree to be bound by these Terms of Use. If you do not agree, please do not use the platform." },
    { title: "2. Licence Grant", content: "K7 Computing grants you a limited, non-exclusive, non-transferable licence to access and use the K7 XDR Platform solely for your organisation's internal security operations purposes." },
    { title: "3. Data Ownership", content: "All security telemetry, logs, and incident data processed through K7 XDR remains the property of your organisation. K7 Computing processes this data solely to deliver the platform services." },
    { title: "4. Data Sovereignty", content: "All data processed by K7 XDR is stored and processed within India, in compliance with applicable Indian data protection laws including the Digital Personal Data Protection Act, 2023." },
    { title: "5. Prohibited Use", content: "You may not use the platform to conduct offensive security operations against third parties, circumvent security controls, or violate any applicable Indian or international law." },
    { title: "6. Service Availability", content: "K7 Computing targets 99.9% platform availability. Planned maintenance windows will be communicated 48 hours in advance." },
    { title: "7. Limitation of Liability", content: "K7 Computing's liability is limited to the fees paid in the preceding 12 months. K7 is not liable for indirect or consequential damages arising from platform use." },
    { title: "8. Governing Law", content: "These terms are governed by the laws of India. Any disputes shall be subject to the exclusive jurisdiction of the courts in Chennai, Tamil Nadu." },
  ]
  return (
