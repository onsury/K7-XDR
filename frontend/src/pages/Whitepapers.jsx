  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-k7-700 via-k7-800 to-k7-900">
      ...
      <div className="max-w-5xl mx-auto px-8 py-16 text-center">
        <h1 className="text-4xl font-bold text-white mb-4">Whitepapers & Research</h1>
        <p className="text-blue-200 mb-16">In-depth technical and regulatory guidance from K7's security research team</p>
        <div className="bg-white/10 border border-white/20 rounded-2xl p-16">
          ...
          <p className="text-blue-200">K7's research publications and technical whitepapers will be available here.</p>
        </div>
      </div>
      <Footer />
    </div>
